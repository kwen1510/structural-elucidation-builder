# 9476 Structural Elucidation Boundaries
...
- Include at least one positive observation and one negative observation.
- Include one clue that rules out a common wrong structure.
- Include a transformation/product clue for medium or hard questions.
- If clues do not determine a unique isomer, either add a locating clue or phrase the prompt as "suggest possible structures".
- Use "explain the chemistry involved" only when the question includes transformations, not just spot tests.
